...
func (b *BackupService) BackupFile(srcPath, dstDir string) (int64, string, error) {
...
func (b *BackupService) BackupFolder(sourceDir, targetRoot string) (int64, string, error) {
